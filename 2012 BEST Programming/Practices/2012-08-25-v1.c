...
//    RightXcu = (((vexRT[Ch1] * vexRT[Ch1]) / 127)); // 'squared' input calculation.
//    RightYcu = (((vexRT[Ch2] * vexRT[Ch2]) / 127));

    RightXcu = (((vexRT[Ch1] * vexRT[Ch1]) / 127)); // 'Cubed' input calculation.
    if(RightX < 0) RightXcu = -RightXcu;
    RightYcu = (((vexRT[Ch2] * vexRT[Ch2]) / 127));
    if(RightY < 0) RightYcu = -RightYcu;
    ...
    if(vexRT[Btn7D])
      ...
      slow = 0; //set to 1 for constant turbo disabled
